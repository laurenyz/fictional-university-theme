...
function university_files(){
    ...
    // moved below when added node => wp_enqueue_script('main-university-js', get_theme_file_uri('/js/scripts-bundled.js'), NULL, microtime(), true);
    ...
    wp_enqueue_script('main-university-js', 'http://localhost:3000/bundled.js', NULL, microtime(), true);
}
